 ...
 <div class="col-sm-5 text-right   " >
    ...
    <h2>Informacion de Cliente</h2>
        <form action="clientesExtrass.php"  method="post">
            ...
            <input type="number" name="tel" class="form-control" min="99999999" max="999999999999" placeholder="Telefono" required><br>
        ...
        <br><br><input type="submit" class="btn-success form-control btn-primary" value="Siguiente">
             ...
             <div class="col-sm-2 sidenav divison"  >
                   <div class="well">';
